...
(add-to-list 'auto-mode-alist '("\\.ha\\'" . c-mode))
(add-to-list 'auto-mode-alist '("\\.fid\\'" . c++-mode))
(add-to-list 'auto-mode-alist '("\\.g4\\'" . antlr-mode))

;; python
(elpy-enable)
(pyvenv-activate "/src/tmvenv")

;; don't fuck with my navigation keys
;; also i don't want to invoke python shell with C-RET
(bind-keys*
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (coffee-mode jsx-mode use-package elpy yaml-mode powerline helm-projectile gruvbox-theme auto-complete)))
...
;; seems like powerline doesn't work if you put this
;; at an earlier location in the file
(powerline-center-theme)
(persistent-scratch-setup-default)

(when (string-equal system-type "windows-nt")
  (cd "C:/Users/Jincheng/Dropbox/"))
